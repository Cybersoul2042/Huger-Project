"""
Django settings for hugersite project.
...
ALLOWED_HOSTS = ['www.plan-plus.ir','plan-plus.ir','plan-plus.onrender.com', '127.0.0.1']
...
WSGI_APPLICATION = 'hugersite.wsgi.application'
